...
def train(args):
    ...
    if not args.test:
        ...
        scannet_absrel = float(scannet_metrics.get("abs_relative_difference", float('nan')))
        ...
        # 베스트 기준을 ScanNet delta1로 시작 (이전 실험과 동일하게 비교하기 위함)
    ...
    logger.info(f"Best Val delta1 (ScanNet): {best_delta1:.4f}")
