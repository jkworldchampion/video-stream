...
# Position Ablation: MIDDLE position (bidirectional context)
# Window: [i-15, ..., i, ..., i+16] → predict frame i
...
INFER_DIR="${ROOT}/benchmark/output/position_middle"
BENCHMARK_ROOT="/home/work/juhwan/monocular_depth/stream/Video-Depth-Anything/datasets"

echo "=========================================="
echo "Position Ablation: MIDDLE"
echo "=========================================="
echo "Window: [i-15, ..., i, ..., i+16] → predict i"
echo "Context: BIDIRECTIONAL (past + future)"
...
echo ""
echo "[Step 1/2] Inference with MIDDLE position..."
...
python "${ROOT}/benchmark/eval/eval.py" \
    ...
    --wandb_run_name "position_middle" \
    --wandb_group "position_ablation" \
    --wandb_mode online

echo ""
echo "✅ MIDDLE position completed!"
echo "=========================================="
